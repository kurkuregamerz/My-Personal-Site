...
// ============================================>
footer_creator();
head.innerHTML += '<link rel="stylesheet" href="src/components/navbar/navbar_style.css">'
head.innerHTML += '<link rel="stylesheet" href="src/components/loader/loader.css">'
head.innerHTML += '<link rel="stylesheet" href="src/components/footer/footer_style.css">'
